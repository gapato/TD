...
\item D\'{e}duire un ordre de grandeur \og raisonnable \fg\ pour le
  ...
  convergence inconditionelle de l'algorithme. Que se passe-t-il si le majorant $C$ est trop
  grossier ?\\
  \textit{Par souçis de simplification, on majore ${\Vert\nabla^2F\Vert}$ au lieu de
  ${\Vert\nabla^2F_{\boldsymbol\mu\Vert}}$.}
