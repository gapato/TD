...
\begin{frame}{Séparation du potentiel}{Action longue distance}
    ...
    » le noyau associé :
    \[\text{pour } x \in \Gamma_i, \Phi(x) = \alpha z \sum_{j\neq i} \frac{1}{|x-R_j|}.\]
\end{frame}
...
\begin{frame}{Minoration de $\mathcal{E}_2$}
    On va maintenant tuer le terme singulier $\int_{B_j} (V-\Psi) \rho$ dans $\mathcal{E}_1$ pour
    pouvoir contrôler l'énergie potentielle :
    \begin{align*}
        \mathcal{E}_1 &=
